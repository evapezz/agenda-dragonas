// frontend/src/pages/RegisterDoctor.jsx
...
const RegisterDoctor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Llamada al endpoint de registro de médico
      ...
      // Si llegó aquí, fue 201
      setSuccessMsg('¡Registro de médico exitoso! Redirigiendo al inicio de sesión...');
      setTimeout(() => {
        navigate('/login');
      }, 2000);
    } catch (err) {
      const data = err.response?.data;
      setErrorMsg(data?.message || 'Error en el registro de médico. Intenta nuevamente.');
    }
  };
          ...
          <Card className="shadow">
            <Card.Body className="p-4">
              <div className="text-center mb-4">
                ...
                <h2 className="mt-3">Registro Médico</h2>
                <p className="text-muted">Crea tu cuenta de médico</p>
              </div>
